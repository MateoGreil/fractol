...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2018/01/10 13:03:07 by mgreil            #+#    #+#             */
/*   Updated: 2018/02/06 09:21:27 by mgreil           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	*mandelbrot_thread(void *e)
{
	int	x;
	int	y;
	int	x_end;
...
void		mandelbrot(t_env *e)
{
	...
	while (i < NB_THREADS)
	{
		if (pthread_create(&thread[i], NULL, &mandelbrot_thread, &env[i]))
			return ;
		i++;
	}
	i = 0;
